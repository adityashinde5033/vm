  ...
  const platforms = [
    {
      ...
      icon: (
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.859L1.254 2.25H8.08l4.259 5.63 5.905-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
        </svg>
      ),
      ...
      <div className={styles.shareWrap}>
        ...
        {open && (
          <div className={styles.card}>
            <div className={styles.cardLabel}>Share this post</div>
            {platforms.map(p => (
              <a
                key={p.label}
                href={p.href}
